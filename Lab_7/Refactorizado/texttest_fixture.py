...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_default(self):
        ...
        gilded_rose.update_quality()  # Dia 1
        ...
        gilded_rose.update_quality()  # Dia 2
        ...
        gilded_rose.update_quality()  # Dia 3
    ...
    def test_aged_brie(self):
        ...
        items = [
            ...
            Item(name=aged_brie, sell_in=5, quality=48),
            Item(name=aged_brie, sell_in=-2, quality=46),
        ]
        ...
        gilded_rose.update_quality()  # Dia 4
    ...
    def test_backstage_passes(self):
        ...
        BPTTC = "Backstage passes to a TAFKAL80ETC concert"
        items = [
            Item(name=BPTTC,
